...
const AppDashboard = () => {
      ...
      <main className="min-h-screen bg-neutral-950 text-white">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-neutral-300">Carregando seu dashboard...</p>
          </div>
        </div>
      </main>
    );
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white p-6 space-y-6">
      ...
      <header className="bg-neutral-900 border border-neutral-700 rounded p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <Avatar className="h-16 w-16 border-2 border-neutral-600">
              ...
              <AvatarFallback className="bg-neutral-800 text-white font-mono text-lg">
            ...
            <div>
              ...
              <div className="text-sm text-neutral-400 font-mono space-y-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="ghost" size="icon" className={`text-neutral-400 ${themeColors.primaryHover}`}>
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-neutral-800 border border-neutral-700 rounded p-3 text-center">
            <div className="text-lg font-bold text-white font-mono">{stats.averageProgress}%</div>
            <div className="text-xs text-neutral-500 uppercase tracking-wider">Progresso</div>
          </div>
          <div className="bg-neutral-800 border border-neutral-700 rounded p-3 text-center">
            <div className="text-lg font-bold text-white font-mono">{stats.completedCourses}</div>
            <div className="text-xs text-neutral-500 uppercase tracking-wider">Concluídos</div>
          </div>
          <div className="bg-neutral-800 border border-neutral-700 rounded p-3 text-center">
            <div className="text-lg font-bold text-white font-mono">{stats.totalBadges}</div>
            <div className="text-xs text-neutral-500 uppercase tracking-wider">Badges</div>
          </div>
          <div className="bg-neutral-800 border border-neutral-700 rounded p-3 text-center">
            <div className={`text-lg font-bold font-mono ${themeColors.primaryText}`}>+{Math.round(stats.totalTimeSpent / 10)} XP</div>
            <div className="text-xs text-neutral-500 uppercase tracking-wider">Hoje</div>
          </div>
        </div>
      </header>
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-neutral-900 border border-neutral-700">
          <TabsTrigger 
            value="overview" 
            className="flex items-center gap-2 data-[state=active]:bg-neutral-800 data-[state=active]:text-white text-neutral-400 font-mono text-xs tracking-wider"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <TacticalChart title="PROGRESSO DOS CURSOS" className="lg:col-span-4">
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-white font-mono">{stats.activeCourses || 0}</div>
                  <div className="text-xs text-neutral-500">Em Andamento</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white font-mono">{stats.completedCourses}</div>
                  <div className="text-xs text-neutral-500">Concluídos</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white font-mono">{stats.totalCourses}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-neutral-900 border-neutral-700">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-neutral-300 tracking-wider text-sm font-medium">
              ...
              <CardContent className="space-y-3">
                ...
                <Button variant="outline" className="w-full border-neutral-600 text-neutral-300 hover:bg-neutral-800 font-mono text-xs tracking-wider" asChild>
                  <Link to="/challenges">
            ...
            <Card className="bg-neutral-900 border-neutral-700">
              ...
              <CardContent>
                <p className="text-sm text-neutral-400 mb-3 font-mono">
