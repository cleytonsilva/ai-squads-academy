...
interface User {
  ...
  subscription_level: 'free' | 'pro' | 'corporate';
  total_points: number;
  is_active: boolean;
}
  ...
  const fetchRankings = async () => {
    try {
      ...
      const { data, error } = await supabase
        ...
        .order('created_at', { ascending: true }); // Em caso de empate, o mais antigo fica na frente
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <p className="font-bold text-gray-900">{userRank.total_points || 0}</p>
