...
export default function CertificateEditor() {
  ...
  const loadCertificateTemplates = async () => {
    ...
    try {
      ...
      toast({
        title: 'Erro',
        description: 'Não foi possível carregar os templates de certificado',
        variant: 'destructive'
      });
    } finally {
      setIsLoading(false);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: 'Erro',
        description: 'Não foi possível salvar o template de certificado',
        variant: 'destructive'
      });
    } finally {
      setIsSaving(false);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast({
        title: 'Sucesso',
        description: 'Template de certificado excluído com sucesso'
      });
      ...
      toast({
        title: 'Erro',
        description: 'Não foi possível excluir o template de certificado',
        variant: 'destructive'
      });
    } finally {
      setDeletingId(null);
  ...
  const CertificatePreview = ({ template }: { template: CertificateTemplate }) => {
    ...
    return (
      ...
      >
        ...
        {/* Title */}
        <h1 className="text-2xl font-bold mb-2">{template.content_template.title}</h1>
        
        {/* Subtitle */}
        <p className="text-lg mb-4">{template.content_template.subtitle}</p>
        ...
        <p className="text-base mb-6">
          {template.content_template.body_text
        ...
        {/* Footer */}
        <p className="text-sm">
          {template.content_template.footer_text
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="title"
                      value={formData.content_template.title}
                      onChange={(e) => setFormData({
                        ...formData,
                        content_template: {
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="subtitle"
                      value={formData.content_template.subtitle}
                      onChange={(e) => setFormData({
                        ...formData,
                        content_template: {
                          ...formData.content_template,
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="body-text"
                      value={formData.content_template.body_text}
                      onChange={(e) => setFormData({
                        ...formData,
                        content_template: {
                          ...formData.content_template,
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="footer-text"
                      value={formData.content_template.footer_text}
                      onChange={(e) => setFormData({
                        ...formData,
                        content_template: {
                          ...formData.content_template,
