...
const engineOptions: EngineOption[] = [
  {
    value: 'flux-1.1-pro',
    label: 'FLUX 1.1 Pro',
    description: 'Modelo mais avançado com qualidade superior e geração 6x mais rápida',
  ...
  },
  {
    ...
    description: 'Modelo especializado em texto e design gráfico com alta velocidade',
  ...
  },
  {
    value: 'flux-schnell',
    label: 'Flux Schnell',
    description: 'Geração rápida com boa qualidade',
    icon: <Zap className="h-4 w-4" />,
    badge: 'Rápido'
  },
  {
    value: 'dreamshaper',
    label: 'DreamShaper',
    description: 'Estilo artístico e criativo',
    icon: <Sparkles className="h-4 w-4" />,
    badge: 'Artístico'
  }
];
