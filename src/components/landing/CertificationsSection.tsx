      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6">
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-slate-900">Ferramentas para certificações de mercado</h2>
            <p className="mt-2 text-slate-700 text-sm md:text-base">
              Prepare-se para certificações como AWS, Azure e Google Cloud com simulados, flashcards e bancos de questões.
              No Free você acessa cursos e certificações básicas. No Pro você desbloqueia certificações exclusivas e labs avançados.
            </p>

            <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 hover:bg-slate-50 transition-all hover:-translate-y-0.5">
