        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="#entrar" className="text-sm font-medium text-slate-700 hover:text-slate-900 px-3 py-2 rounded-md transition-all hover:-translate-y-0.5 hover:shadow-sm">Entrar</a>
              <a href="#comecar" className="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-md bg-slate-900 text-white hover:bg-slate-800 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
            ...
            <details className="lg:hidden group relative">
              ...
              <div className="absolute right-0 mt-3 w-[88vw] max-w-xs rounded-lg border border-slate-200 bg-white shadow-xl p-2 transition-all">
                <div className="flex flex-col">
                  ...
                  <a href="#entrar" className="px-3 py-2 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">Entrar</a>
                  <a href="#comecar" className="mt-1 inline-flex items-center justify-center gap-2 text-sm font-medium px-3 py-2 rounded-md bg-slate-900 text-white hover:bg-slate-800 transition-all hover:-translate-y-0.5 hover:shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                      <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"></path>
                      <path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"></path>
                      <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
